  ...
  return (
    <div className="product-detail-page">
      ...
      <style jsx>{`
        ...
        .price-block { margin-bottom: 2.5rem; display: flex; align-items: baseline; gap: 1rem; }
        ...
        .btn-wa { background: #25D366; border-color: #25D366; justify-content: center; }
        .btn-wa:hover { background: #1da856; border-color: #1da856; }
        ...
        .product-benefits li::before { content: '—'; position: absolute; left: 0; color: var(--color-accent); font-weight: 500; }
        ...
        @media (max-width: 600px) {
          .price-block { flex-direction: column; gap: 0.25rem; }
